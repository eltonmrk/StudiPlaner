...
public class ActivityLecturer extends ActivityDB {
	Lecturer lehrender;
	Task notizen;
		...
		ListAdapter lAdapter = new ArrayAdapter<Map<String, String>>(this, R.layout.listrow, lehrende) {
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				if (dozent.size() == 1) {
					...
					Intent i = new Intent(thisActivity.getApplicationContext(), SubActivityLecturerModEdit.class);
					Bundle b = new Bundle();
	...
	public void initActionBar() {
		...
		Intent createI = new Intent(this, SubActivityLecturerModAdd.class);
