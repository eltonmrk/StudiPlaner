...
import com.studiplaner.SubActivities.Scheduler.SubActivityPostOnFacebook;
	...
	private final class ButtonOnClickListener implements OnClickListener {
		...
		public void onClick(View arg0) {
			if (mFb.isSessionValid()) {
				...
				mFb.authorize(getContext(), SubActivityPostOnFacebook.APP_ID, mPermissions, new LoginDialogListener());
			}
		}
	}
